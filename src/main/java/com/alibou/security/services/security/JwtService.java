...
public class JwtService {
    ...
    public String extractUsername(String token) {
        // Subject claim it is the Username or Email.
        Function<Claims, String> subjectClaim = Claims::getSubject;
        return extractClaim(token, subjectClaim);
    }

    /**
     * Extracts a claim from the provided token using the specified claims' resolver.
     * Utility method that works to extract any type of claim from the token claims, it is generic method so, it will work to extract any claim from any type.
     *
